...
public class RegisteredUser_Pickup_Future_Ordering_ByCash extends Listeners {
	
	
	@Test
	public void ValidateRegisteredUser_Pickup_Future_Ordering_ByCash() throws IOException, InterruptedException
	{
